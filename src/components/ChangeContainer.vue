      ...
      <Filters @onFilterApplied="onFilterApplied"/>
        <div class="__table">
            <table id="change-table">
              ...
              <tbody>
                <ChangeItem v-for="(change, i) in changes" :key="i" :change="change" :cellsCount="cellsCount" :isSelected="selectedChangesId.includes(change.id)" @onMarked="onChangeClicked"/>
              </tbody>
